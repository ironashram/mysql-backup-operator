...
func (in *ExecutorSpec) DeepCopyInto(out *ExecutorSpec) {
	*out = *in
	in.Mysqldump.DeepCopyInto(&out.Mysqldump)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MysqlSecretRefSpec) DeepCopyInto(out *MysqlSecretRefSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MysqlSecretRefSpec.
func (in *MysqlSecretRefSpec) DeepCopy() *MysqlSecretRefSpec {
	if in == nil {
		return nil
	}
	out := new(MysqlSecretRefSpec)
	in.DeepCopyInto(out)
	return out
}
